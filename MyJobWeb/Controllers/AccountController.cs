...
namespace MyJobWeb.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                ViewBag.UserType = new SelectList(db.Roles.Where(a => !a.Name.Contains("Admin")).ToList(), "Name", "Name");
                var user = new ApplicationUser { FullName = model.FullName, UserName = model.Email, Email = model.Email ,UserType=model.UserType};
        ...
        public ActionResult EditeProfile()
        {
            ...
            EditeProfileViewModel profile = new EditeProfileViewModel();
        ...
        public ActionResult EditeProfile(EditeProfileViewModel profile)
        {
            if (ModelState.IsValid) {
                ...
                {
                    ViewBag.Message = "Your Current Password";
                }
                else
                {
